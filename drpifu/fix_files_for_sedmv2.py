...
def add_header_keywords(filename,sciexptime=60):
    ...
    if ('speccal_xe' in hdr['FILENAME']):
        ...
        fits.setval(filename, 'DOMESTAT', value='closed')
        fits.setval(filename, 'LAMPCUR', value=0.0)
        fits.setval(filename, 'OBJECT', value='arc_xe')
        fits.setval(filename, 'NAME', value='arc_xe')
        fits.setval(filename, 'CRVAL1', value=155.4749009102372)
        fits.setval(filename, 'CRVAL2', value=88.6437849176057)
    if ('speccal_hg' in hdr['FILENAME']):
        ...
        fits.setval(filename, 'DOMESTAT', value='closed')
        fits.setval(filename, 'LAMPCUR', value=0.0)
        fits.setval(filename, 'OBJECT', value='arc_hg')
        fits.setval(filename, 'NAME', value='arc_hg')
        fits.setval(filename, 'CRVAL1', value=155.4749009102372)
        fits.setval(filename, 'CRVAL2', value=88.6437849176057)
    if ('speccal_cd' in hdr['FILENAME']):
        ...
        fits.setval(filename, 'DOMESTAT', value='closed')
        fits.setval(filename, 'LAMPCUR', value=0.0)
        fits.setval(filename, 'OBJECT', value='arc_cd')
        fits.setval(filename, 'NAME', value='arc_cd')
        fits.setval(filename, 'CRVAL1', value=155.4749009102372)
        fits.setval(filename, 'CRVAL2', value=88.6437849176057)
